...
const fleetVehicles = [
  ...
  ['IMG-20260822-WA0013.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse bâchée'],
  ...
  ['IMG-20260822-WA0036.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse à ridelles'],
  ['IMG-20260822-WA0037.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse à ridelles'],
  ...
  ['IMG-20260822-WA0040.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse à ridelles'],
  ...
  ['IMG-20260822-WA0045.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse à ridelles'],
  ['IMG-20260822-WA0046.jpg', 'Mercedes-Benz Actros', 'Camion de transport', 'Caisse bâchée'],
  ['IMG-20260822-WA0049.jpg', 'Mercedes-Benz Actros 3340', 'Camion de transport', 'Caisse à ridelles'],
];
    ...
    const cardFor = ([image, name, type, body]) => `
      <article class="car-card">
        <div class="car-image" style="background-image: url('images/flotte/${image}')">
          <span class="tag">Flotte Albork</span>
          <span class="availability">Photo réelle</span>
          <a class="image-reserve-button" href="https://wa.me/23672424747" target="_blank" rel="noreferrer">Réserver <span>↗</span></a>
        </div>
        <div class="car-body">
          <h3>${name}</h3>
          ...
          <a href="#contact">Demander les détails <span>↗</span></a>
        </div>
      </article>
    `;
